...
In the first and initial version of _CSS Optimization Basics_, there are probably a few errors and typos. There will also be more that not only could but _should_ be said about CSS optimization. (Note that the book is a lot about the _craft_ and the _basics_ of writing CSS.)
